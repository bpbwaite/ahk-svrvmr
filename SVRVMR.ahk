...
global HMD_Bus := "1"
global VRActivePid := "firefox.exe"
global busGain = 0.0
global gainCurve = 4.0
global gainOffset = 1.0
global Update_Period_ms := 500
...
global Volume := GetVolumeObject(VRActivePid)
if !(Volume)
...
;
UpdateFunc(vol_obj) {
    static gainbuffer := 1.0
    static last := 1.0
    VA_ISimpleAudioVolume_GetMasterVolume(vol_obj, gainbuffer)
...
; extensions of VA_, required for application specific control
